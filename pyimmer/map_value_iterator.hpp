...
static PyObject *py_immer_map_value_iterator_new(PyTypeObject *type,
  ...
  py_immer_map_value_iterator->py_immer_map =
      (pyimmer::map::py_immer_map_t *)py_immer_map;
  auto &immer_map = py_immer_map_value_iterator->py_immer_map->immer_map;
...
static PyObject *py_immer_map_value_iterator_next(
  ...
  py_immer_map_value_iterator->index = py_immer_map_value_iterator->length;
  return NULL;
}
...
static void py_immer_map_value_iterator_dealloc(
  ...
  Py_INCREF(py_immer_map_value_iterator->py_immer_map);
