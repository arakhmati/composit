...
extern "C" void run(const data_type_t* input_buffer,
  ...
  auto query_weights = as_lazy_computation<data_type_t, sonic::shape::shape_t<n_size, k_size>>(
  ...
  auto output = linear_with_transposed_input_b(input, query_weights, query_bias);
